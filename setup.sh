...
echo "  ./venv/bin/python -m iaq4j train --model kan        # Train KAN model"
echo "  ./venv/bin/python -m iaq4j train --model cnn        # Train CNN model"
echo "  ./venv/bin/python -m iaq4j train --model all        # Train all models"
echo "  ./venv/bin/python -m app.main                        # Start API server"
echo "  ./venv/bin/python test_client.py                      # Test API endpoints"
echo ""
echo "Example usage:"
echo "  ./venv/bin/python -m iaq4j train --model lstm --epochs 50"